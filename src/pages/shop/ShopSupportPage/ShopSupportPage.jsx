...
const ShopSupportPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    submitSupportRequest({ subject, message, category, fromRole: 'shop' });
    setSubject('');
    setMessage('');
    setCategory('order');
  };
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">🆘 Hỗ trợ cho Shop</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg border">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input value={subject} onChange={(e) => setSubject(e.target.value)} className="w-full p-3 border rounded-md" placeholder="Ví dụ: Vấn đề đơn hàng/Thanh toán" />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea value={message} onChange={(e) => setMessage(e.target.value)} rows={6} className="w-full p-3 border rounded-md" placeholder="Mô tả chi tiết vấn đề của shop..." />
            </div>
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          {myRequests.length === 0 ? (
            <div className="text-gray-600">Shop chưa gửi yêu cầu nào.</div>
          ) : (
